...
class Video extends Init
{
    ...
    function index(){
        ...
        $videos = $this->model->get_list($map,$order,$page_size);
        return view('list',['category_id'=>$category_id,'videos'=>$videos,'url_params_arr'=>$url_params_arr,'url_params_str'=>$url_params_str]);
    }
    ...
    function edit(){
        ...
        $video = $this->model->where('id',input('param.id'))->find();
        $model_category_select_option = $this->category_model->get_model_category_select_with_option($video['category_id']);
        return view('edit',array('video'=>$video,'model_category_select_option'=>$model_category_select_option));
    }
