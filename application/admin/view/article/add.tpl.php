...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      ...
      <a href="<?php echo url('article/index','category_id='.$category_id) ?>"><li>列表</li></a>
      <a href="<?php echo url('article/add','category_id='.$category_id) ?>"><li class="layui-this">添加</li></a>
    </ul> 
    <div class="layui-tab-content">
       <form class="layui-form">
        <div class="layui-tab-item layui-show">
          ...
          <?php echo Form::umeditor('content','','内容');?>
  ...
  form.on('submit(article_add)', function(data){
    ...
    $.ajax({
      ...
      success:function(data){
        if(data.code == 200){
          show_msg(data.msg,1,'{:url("article/index",["category_id"=>$category_id])}');
        }else{
          show_msg(data.msg,2);
        }
      },
