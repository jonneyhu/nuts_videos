...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      ...
      <a href="<?php echo url('link/index') ?>"><li class="layui-this">列表</li></a>
    ...
    <div class="layui-tab-content">
      <div class="layui-tab-item layui-show">
        <div class="table_top_bar"> 
          ...
          <a href="<?php echo url('link/index') ?>"><i class="layui-icon">&#x1002;</i>刷新</a>
        </div>
        ...
        <table class="layui-table" lay-even>
          ...
          <?php foreach ($links['data'] as $v) { ?>
            <tr>
              ...
              <td>
                <a href="<?php echo url('link/edit',['id'=>$v['id']]) ?>" class="layui-btn layui-btn-mini" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                <a class="layui-btn layui-btn-danger layui-btn-mini del_btn" link-id="<?php echo $v['id'] ?>" title="删除"><i class="layui-icon">&#xe640;</i></a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
