...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      ...
      <a href="<?php echo url('worker/index','category_id='.$category_id) ?>"><li class="layui-this">列表</li></a>
      <a href="<?php echo url('worker/add','category_id='.$category_id) ?>"><li>添加</li></a>
    </ul>
    <div class="layui-tab-content">
      <div class="layui-tab-item layui-show">
        <div class="table_top_bar"> 
          ...
          <div class="spacer-gray"></div>
          <a href="<?php echo url('worker/index','category_id='.$category_id) ?>"><i class="layui-icon">&#x1002;</i>刷新</a>
          <div class="spacer-gray"></div>
        ...
        <table class="layui-table" lay-even>
          ...
          <?php foreach ($workers['data'] as $v) { ?>
            <tr>
              ...
              <td>
                <a href="<?php echo url('worker/edit',['id'=>$v['id']]) ?>" class="layui-btn layui-btn-mini" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                <a class="layui-btn layui-btn-danger layui-btn-mini del_btn" worker-id="<?php echo $v['id'] ?>" title="删除"><i class="layui-icon">&#xe640;</i></a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
...
layui.use(['element','table','form','laypage'], function(){
  ...
  laypage.render({
    elem: 'page'
    ,count: {$workers['total']}
    ,curr: {$workers['current_page']}
    ,limit: {$workers['per_page']}
