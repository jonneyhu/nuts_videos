...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
        ...
        <a href="<?php echo url('video/index','category_id='.$category_id) ?>"><li class="layui-this">列表</li></a>
        <a href="<?php echo url('video/add','category_id='.$category_id) ?>"><li>添加</li></a>
    </ul>
    <div class="layui-tab-content">
        <div class="layui-tab-item layui-show">
            <div class="table_top_bar">
                ...
                <div class="spacer-gray"></div>
                <a href="<?php echo url('video/index','category_id='.$category_id) ?>"><i class="layui-icon">&#x1002;</i>刷新</a>
                <div class="spacer-gray"></div>
            ...
            <form class="layui-form">
                <table class="layui-table" lay-even>
                    ...
                    <tbody>
                    <?php foreach ($videos['data'] as $v) { ?>
                        <tr>
                            <td><input type="checkbox" name="ids[<?php echo $v['id'] ?>]" value="<?php echo $v['id'] ?>" lay-skin="primary" lay-filter="checkOne"></td>
                            <td><?php echo $v['id']; ?></td>
                            <td>
                                <a class="list-title" href="<?php if($v['url']){ echo $v['url'];}else{ echo url('index/video/show','id='.$v['id']);} ?>" target="_blank"><?php echo $v['title']; ?></a>
                                <?php if($v['image_url']){ ?>
                            ...
                            <td>
                                <a href="javascript:;" data-href="<?php echo url('collection/index',['video_id'=>$v['id']]) ?>" class="layui-btn layui-btn-mini collection_btn" data-title="<?php echo $v['title']; ?>-剧集管理" title="剧集">剧集</a>
                                <a href="<?php echo url('video/edit',['id'=>$v['id']]) ?>" class="layui-btn layui-btn-mini" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                                <a class="layui-btn layui-btn-danger layui-btn-mini del_btn" video-id="<?php echo $v['id'] ?>" title="删除"><i class="layui-icon">&#xe640;</i></a>
                            </td>
                        </tr>
                    <?php } ?>
                    </tbody>
...
<script type="text/javascript">
    layui.use(['element','table','form','laypage'], function(){
        ...
        laypage.render({
            elem: 'page'
            ,count: {$videos['total']}
            ,curr: {$videos['current_page']}
            ,limit: {$videos['per_page']}
