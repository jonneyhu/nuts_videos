...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      ...
      <a href="<?php echo url('recruit/index','category_id='.$category_id) ?>"><li class="layui-this">列表</li></a>
      <a href="<?php echo url('recruit/add','category_id='.$category_id) ?>"><li>添加</li></a>
    </ul>
    <div class="layui-tab-content">
      <div class="layui-tab-item layui-show">
        <div class="table_top_bar"> 
          ...
          <div class="spacer-gray"></div>
          <a href="<?php echo url('recruit/index','category_id='.$category_id) ?>"><i class="layui-icon">&#x1002;</i>刷新</a>
          <div class="spacer-gray"></div>
        ...
        <table class="layui-table" lay-even>
          ...
          <tbody>
          <?php foreach ($recruits['data'] as $v) { ?>
            <tr>
              ...
              <td>
                <a href="<?php echo url('recruit/edit',['id'=>$v['id']]) ?>" class="layui-btn layui-btn-mini" title="编辑"><i class="layui-icon">&#xe642;</i></a>
                <a class="layui-btn layui-btn-danger layui-btn-mini del_btn" recruit-id="<?php echo $v['id'] ?>" title="删除"><i class="layui-icon">&#xe640;</i></a>
              </td>
            </tr>
          <?php } ?>
          </tbody>
...
layui.use(['element','table','form','laypage'], function(){
  ...
  $('#batches_delete').click(function(){
    ...
    layer.confirm('确定删除['+ids+']?', function(index){
      ...
      $.ajax({
        type:'post',
        dataType:'json',
        url:'{:url("recruit/batches_delete")}',
        data:{'ids':ids},
        success:function(data){
          if(data.code == 200){
            show_msg(data.msg,1,'reload');
  ...
  laypage.render({
    elem: 'page'
    ,count: {$recruits['total']}
    ,curr: {$recruits['current_page']}
    ,limit: {$recruits['per_page']}
