...
<div class="layui-tab layui-tab-brief main-tab-container">
    <ul class="layui-tab-title main-tab-title">
      ...
      <a href="<?php echo url('focus/add') ?>"><li class="layui-this">添加</li></a> 
    </ul> 
    <div class="layui-tab-content">
       <form class="layui-form">
        <div class="layui-tab-item layui-show">
          ...
          <?php echo Form::textarea('description','','描述','轮播图描述，最多不超过250个字符');?>
          <?php echo Form::input('sort','20','排序','数字越小越靠前','数字','number');?>
          <?php echo Form::radio('is_show',1,'是否启用','用于前台显示调用',array(1=>'是',0=>'否'));?>
          
          <div class="layui-form-item">
            <div class="layui-input-block">
              <button class="layui-btn" lay-submit="" lay-filter="focus_add">立即提交</button>
            </div>
          </div>
        </div>   
      </form>
...
layui.use(['element', 'form'], function(){
  ...
  //监听提交
  form.on('submit(focus_add)', function(data){
