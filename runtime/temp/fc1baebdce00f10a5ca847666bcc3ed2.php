<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"/www/wwwroot/video.com/application/admin/view/index/index.tpl.php";i:1601170315;s:66:"/www/wwwroot/video.com/application/admin/view/public/toper.tpl.php";i:1530175630;s:67:"/www/wwwroot/video.com/application/admin/view/public/footer.tpl.php";i:1503323382;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    ...
    <ul class="layui-nav layui-layout-right">
      <!-- <li class="layui-nav-item">
        <a href="javascript:;">
          <img src="<?php echo $admin_user['avatar']; ?>" class="layui-nav-img">
          <?php if($admin_user['name']): ?><?php echo $admin_user['name']; else: ?><?php echo $admin_user['username']; endif; ?>
        </a>
  ...
  <div class="layui-footer">
    <a target="_blank" href="/"><?php echo $settings['copy']; ?></a>
  </div>
</div>
<script>
//JavaScript代码区域
layui.use(['layer', 'element','tree'], function(){
  ...
  $('.layui-layout-left .content_item').click(function(){
    ...
    $.ajax({
        type:'get',
        dataType:'json',
        url:'<?php echo url("category/manage_tree"); ?>',
